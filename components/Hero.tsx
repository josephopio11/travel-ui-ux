    ...
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        ...
        <p className='regular-16 mt-6 text-gray-30 xl:max-w-[520px]'>
          ...
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem, perspiciatis voluptas alias delectus error non?
        </p>
        <div className='my-11 flex flex-wrap gap-5'>
          ...
          <p className='bold-16 lg:bold-20 text-blue-70'>
            972k
            <span className='regular-16 lg:regular-20 ml-1'>Cool reviews</span>
          </p>
        </div>
      ...
      <div className='relative flex flex-1 items-start opacity-80'>
